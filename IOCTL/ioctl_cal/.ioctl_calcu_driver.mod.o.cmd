...
ioctl_calcu_driver.mod.o: $(deps_ioctl_calcu_driver.mod.o)

$(deps_ioctl_calcu_driver.mod.o):

ioctl_calcu_driver.mod.o: $(wildcard /usr/src/linux-headers-6.17.0-14-generic/tools/objtool/objtool)
