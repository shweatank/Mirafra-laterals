...
static int __init memdemo_init(void)
{
    ...
    pr_info("memdemo: loaded (kmalloc=%d bytes, vmalloc=%lu bytes)\n",
...
MODULE_DESCRIPTION("kmalloc + vmalloc memory demo driver");