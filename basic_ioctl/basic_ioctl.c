/*IOCTL eg : send an int from user -> kernel -> modify -> return */
                        ...
                        unsigned long arg)
{
    ...
    switch(cmd){
        case IOCTL_SET_VALUE :
            ...
            pr_info("Kernel recieved %d from user\n", user_value);
...
static int __init basic_init(void){
    ...
    pr_info("Basic ioctl loaded , major number = %d\n", major);
    return 0;
}
